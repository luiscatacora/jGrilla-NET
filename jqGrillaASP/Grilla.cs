...
{
    ///<summary>
    ///Determina la contruccion de la Grilla jqGrid.
    ///</summary>
    public class Grilla : IHtmlString
    {
        ...
        private List<Opciones> Opcion = new List<Opciones>()
        {
            ...
            new Opciones{idx="rowNum",val = "15" },
        ...
        ///</summary>
        public Grilla(string id = "grid", string pagina = "pager")
        {
        ...
        ///</summary>
        public Grilla setNavEdit(string nombre, string valor)
        {
            return setNav(nombre, valor, "edit");
        }
        public Grilla setNavEdit(bool edit = true)
        {
        ...
        ///</summary>
        public Grilla setNavAdd(string nombre, string valor)
        {
            return setNav(nombre, valor, "add");
        }
        public Grilla setNavAdd(bool add = true)
        {
        ...
        ///</summary>
        public Grilla setNavDel(string nombre, string valor)
        {
            return setNav(nombre, valor, "del");
        }
        public Grilla setNavDel(bool del = true)
        {
        ...
        ///</summary>
        public Grilla setNavView(string nombre, string valor)
        {
            return setNav(nombre, valor, "view");
        }
        public Grilla setNavView(bool view = true)
        {
        ...
        ///</summary>
        public Grilla setNavSeach(string nombre, string valor)
        {
            return setNav(nombre, valor, "seach");
        }
        public Grilla setNavSeach(bool search = true)
        {
            return setNav("seach", search.ToString().ToLower(), "nav");
        }

        public Grilla setNavExcel(bool excel = true)
        {
            return setNav("excel", excel.ToString().ToLower(), "nav");
        }
        private List<string> navBoton = new List<string>();
        ///<summary>
        ///Agrega botones personalizados en la barra de navegación.
        ///</summary>
        public Grilla setNavBoton(NavBoton boton)
        {
            navBoton.Add(boton.getBoton(_id, _pagina));
            return this;
        }
        ///<summary>
        ///Habilita o deshabilita los botones de la barra de navegacion.
        ///</summary>
        public Grilla setVerBotonNav()//(bool edit = true, bool add = true, bool del = true, bool view = true, bool search = true, bool excel = true, bool pdf = true)
        {
        ...
        ///</summary>
        public Grilla setNav(string nombre, string valor, string tipo = "nav")
        {
        ...
        ///</summary>
        public Grilla setUrl(string url)
        {
            dataUrl = url;
            setOpcion("url", url);
            return this;
        ...
        ///<summary>
        ///Determina el numero de registros que se mostraran al inicio.
        ///</summary>
        public Grilla setNumeroFila(int numeroFila)
        {
            setOpcion("rowNum", numeroFila.ToString());
            return this;
        }
        ///<summary>
        ///Determina la URL donde serán actualizados los registros.
        ///</summary>
        public Grilla setUrlEdita(string url)
        {
            editUrl = url;
            setNavEdit("url", url);
        ...
        ///</summary>
        public Grilla setUrlNuevo(string url)
        {
            addUrl = url;
            setNavAdd("url", url);
            return this;
        ...
        ///</summary>
        public Grilla setUrlBorrar(string url)
        {
            delUrl = url;
            setNavDel("url", url);
            return this;
        ...
        ///</summary>
        public Grilla setUrlExcel(string url)
        {
            urlExcel = url;
            return this;
        }
        ...
        ///</summary>
        public Grilla setUrlPDF(string url)
        {
            urlPDF = url;
            return this;
        }
        ...
        ///</summary>
        public Grilla setTipoDato(Dato val)
        {
        ...
        ///</summary>
        public Grilla setTitulo(string val)
        {
        ...
        ///</summary>
        public Grilla setOrdenMultiple(bool valor = true)
        {
        ...
        ///</summary>
        public Grilla setOrden(bool valor = true)
        {
        ...
        ///</summary>
        public Grilla setOrden(string valor)
        {
        ...
        ///</summary>
        public Grilla setOrden(string valor, Orden orden)
        {
            setOpcion("sortname", valor);
        ...
        ///</summary>
        public Grilla setOrden(Orden valor)
        {
        ...
        ///</summary>
        public Grilla setAlto(int valor)
        {
        ...
        ///</summary>
        public Grilla setAncho(int valor)
        {
        ...
        ///</summary>
        public Grilla setAncho(bool valor = true)
        {
        ...
        ///</summary>
        public Grilla filaCebra(bool valor = true)
        {
        ...
        ///</summary>
        public Grilla seleccionMultiple(bool valor = true)
        {
        ...
        ///</summary>
        public Grilla subGrilla(bool valor = true)
        {
            return setOpcion("subGrid", valor.ToString().ToLower());
        }
        ///<summary>
        ///Determina la posición de los registros en la Grilla. Los valores pueden ser left, right, center.
        ///</summary>
        public Grilla setPosicion(Posicion valor)
        {
     ...
     */
        ...
        ///</summary>
        public Grilla esAgrupado(bool valor = true)
        {
            return setOpcion("grouping", valor.ToString().ToLower());
        }
        public Grilla setAgrupar(Grupo valor)
        {
            //valor.grupo
        ...
        public Grilla setOpcion(string nombre, string valor)
        {
        ...
        ///</summary>
        public Grilla setEvento(string evento, string valor)
        {
        ...
        private string getConvertir(List<Opciones> ope, bool esLis = false,bool esSub=false)
        {
            ...
            foreach (Opciones val in ope) //val.Value or val.Key
            {
                ...
                {
                    if (esSub) {
                        tmpResp[i] = val.idx + ": '" + val.val + "?idePade='+ide";
                    }
                    else
                    {
                        tmpResp[i] = val.idx + ": '" + val.val + "'";
        ...
        public Grilla setColumna(Columna columnas)
        {
        ...
        public Grilla setAgrupaTitulo(string columnaInicio, int numero, string titulo)
        {
        ...
        public Grilla setFiltro(Filtro valor)
        {
            filtro = valor.filtro;
            return this;
        }
        bool editaLinea = false;
        public Grilla editaEnLineaNav(bool enLinea = true)
        {
            editaLinea = enLinea;
            return this;
        }
        string editLinea = "";
        //string editLineaCol = "";
        public Grilla editaEnLinea(bool edita = true, bool borrar = true)
        {
        ...
        private string idePadre = "";
        public Grilla setSubGrillaIdPadre(string idPadre)
        {
            idePadre = idPadre;
            return this;
        }
        public Grilla setSubGrilla(Grilla valor)
        {
            //esSubGrilla = true;
            setOpcion("subGrid", "true");
            setOpcion("subGridOptions", @"js:{
                        plusicon: 'ace-icon fa fa-plus center bigger-110 blue',
                        minusicon: 'ace-icon fa fa-minus center bigger-110 blue',
                        openicon: 'ace-icon fa fa-chevron-right center orange'
                    }");
            setOpcion("subGridRowExpanded", @"js:" + valor.GeneraSubGrilla());
            /*setOpcion("subGridRowExpanded", @"js:" + //valor.GeneraSubGrilla());
            @"function (subgridDivId, rowId) {
        ...
        public Grilla usarToken()
        {
            token = true;
            return this;
        }

        public Grilla setDobleClic(string nombreFuncion)
        {
            setOpcion("ondblClickRow", "js:function(rowId){ var dato = $(this).jqGrid('getRowData', rowId); " + nombreFuncion + "(dato);" + "}");
            return this;
        }
        internal string GeneraSubGrilla()
        {
            var resultado = new StringBuilder();
            resultado.AppendLine(@"function(subgridDivId, rowId) {
                var subgridTableId = subgridDivId + '_t_" + _id + @"';
                var subgridPagerId = subgridDivId + '_p_" + _pagina + @"'
                $('#' + subgridDivId).html('<table id=""' + subgridTableId + '"" class=""scroll""></table><div id=""' + subgridPagerId + '"" class=""scroll""></div>');
                var ide = $(this).jqGrid('getCell', rowId, '" + idePadre + @"');
            ");
            resultado.AppendLine("jQuery('#' + subgridTableId).jqGrid({ " + getConvertir(Opcion) + ",");
            resultado.AppendLine("postData: {idPadre: ide},editData:{idePadre: ide},pager:subgridPagerId,");
            ...
            resultado.AppendLine("jQuery('#' + subgridTableId).jqGrid('navGrid','#'+subgridPagerId,{");
            /***************************************/
            /*/
                        var obj = opcionEdit.FirstOrDefault(x => x.idx == 'url');
            if (obj != null)
            {
                obj.val = obj.val+"?idePadre=";
                }
                */
            resultado.AppendLine(getConvertir(opcionBarra) + "},{");
            resultado.AppendLine(getConvertir(opcionEdit,false,true) + "},{");
            resultado.AppendLine(getConvertir(opcionAdd, false, true) + "},{");
            resultado.AppendLine(getConvertir(opcionDel, false, true) + "},{");
            ...
            if (opcionBarra.FirstOrDefault(x => x.idx == "excel" && x.val == "true") != null)
            {
                if (urlExcel == "")
                    urlExcel = dataUrl;
                resultado.AppendLine(@"jQuery('#' + subgridTableId).jqGrid('navButtonAdd','#'+subgridPagerId, {id: 'exporta_xls',caption: '', buttonicon: 'ace-icon fa fa-file-excel-o green', title: 'Exportar a excel', onClickButton:  function(e){
                    try {
                        jQuery('#' + subgridTableId).jqGrid('excelExport',{ tag: 'excel', url: '" + urlExcel + @"'});
                    } catch (e) {
            ...
            if (opcionBarra.FirstOrDefault(x => x.idx == "pdf" && x.val == "true") != null)
            {
                ...
                resultado.AppendLine(@"jQuery('#' + subgridTableId).jqGrid('navButtonAdd','#'+subgridPagerId, {id: 'exporta_pdf',caption: '', buttonicon: 'ace-icon fa fa-file-pdf-o red', title: 'Exportar a PDF', onClickButton:  function(e){
                    try {
                        jQuery(''#' + subgridTableId').jqGrid('excelExport',{ tag: 'pdf', url: '" + urlPDF + @"'});
                    } catch (e) {
            ...
            {
                resultado.AppendLine("jQuery('#' + subgridTableId).jqGrid('useColSpanStyle: true, setGroupHeaders',{" + getConvertir(grupoTitulo) + "}");
            }
            if (editaLinea)
            {
                ...
                resultado.AppendLine("jQuery('#' + subgridTableId).jqGrid('setFrozenColumns');");
                resultado.AppendLine(@"jQuery('#' + subgridTableId).jqGrid('inlineNav', '#'+subgridPagerId, {
            ...
            if (filtro.Count() > 0)
            {
                resultado.AppendLine("jQuery('#' + subgridTableId).jqGrid('filterToolbar',{" + getConvertir(filtro) + "});");
            }
            resultado.AppendLine("$('#' + subgridPagerId + ' option[value=99999999]').text('Todos');");
            /***************************************/
            resultado.AppendLine("}");
            return Convert.ToString(resultado);
        }
        internal string GeneraGrilla(bool esSub = false)
        {
            if (esSub) esSubGrilla = true;
            var resultado = new StringBuilder();
            ...
            if (esSubGrilla)
            {
                resultado.AppendLine(@"function(subGrid_" +this._id + @", rowId) {
						var ideGrilla = " + this._id + @" + '_t';
                        var idePagina = '" + this._pagina + @"'
						$('#' + subGrid_" + this._id + @").html('<table id=""' + ideGrilla + '""></table><div id=""' + idePagina + '""></div>');
                        ideGrilla ='#'+ideGrilla;
                ");
            ...
            else
            {
                ...
                resultado.AppendLine(@"var ideGrilla = '#" + this._id + "'; var idePagina = '#" + this._pagina + "';");

                resultado.AppendLine(@"var columnaPadre = $(ideGrilla).closest('[class*=""col-""]'); $(window).on('resize.jqGrid', function () { $(ideGrilla).jqGrid('setGridWidth', columnaPadre.width());})
                ...
                setTimeout(function () {$(ideGrilla).jqGrid('setGridWidth', columnaPadre.width()); }, 20);}
                })");

              /*  resultado.AppendLine(@"$(window).bind('resize', function() {
                    var width = $('.jqGrid_wrapper').width();
                $(ideGrilla).setGridWidth(width);
               
                });");*/

            }

            resultado.AppendLine("jQuery(ideGrilla).jqGrid({ " + getConvertir(Opcion) + ",");
            ...
            resultado.AppendLine("jQuery(ideGrilla).jqGrid('navGrid',idePagina,{");
            resultado.AppendLine(getConvertir(opcionBarra) + "},{");
            ...
            if (opcionBarra.FirstOrDefault(x => x.idx == "excel" && x.val == "true") != null)
            {
                if (urlExcel == "")
                    urlExcel = dataUrl;
                resultado.AppendLine(@"jQuery(ideGrilla).jqGrid('navButtonAdd',idePagina, {id: 'exporta_xls',caption: '', buttonicon: 'ace-icon fa fa-file-excel-o green', title: 'Exportar a excel', onClickButton:  function(e){
                    try {
                        jQuery(ideGrilla).jqGrid('excelExport',{ tag: 'excel', url: '" + urlExcel + @"'});
                    } catch (e) {
                        window.location = '" + urlExcel + @"?oper=excel';
                    }
                }});");
            ...
            {
                if (urlPDF == "") urlPDF = dataUrl;
                resultado.AppendLine(@"jQuery(ideGrilla).jqGrid('navButtonAdd',idePagina, {id: 'exporta_pdf',caption: '', buttonicon: 'ace-icon fa fa-file-pdf-o red', title: 'Exportar a PDF', onClickButton:  function(e){
                    try {
                        jQuery('ideGrilla').jqGrid('excelExport',{ tag: 'pdf', url: '" + urlPDF + @"'});
                    } catch (e) {
                        window.location = '" + urlPDF + @"?oper=pdf';
                    }
                }});");
            ...
            if (grupoTitulo.Count() > 0)
            {
                resultado.AppendLine("jQuery(ideGrilla).jqGrid('useColSpanStyle: true, setGroupHeaders',{" + getConvertir(grupoTitulo) + "}");
            }
 ...
 alert('');
            ...
            if (editaLinea)
            {
                ...
                resultado.AppendLine("jQuery(ideGrilla).jqGrid('setFrozenColumns');");
                resultado.AppendLine(@"jQuery(ideGrilla).jqGrid('inlineNav', idePagina, {
                     addicon:'fa fa-plus-square',
                     editicon:'fa fa-pencil-square',
                     saveicon:'fa fa-floppy-o',
                     addParams: {
            ...
            if (filtro.Count() > 0)
            {
                resultado.AppendLine("jQuery(ideGrilla).jqGrid('filterToolbar',{" + getConvertir(filtro) + "});");
            }
            
            //resultado.AppendLine("jQuery(ideGrilla).jqGrid('showHideColumnMenu');");
            // resultado.AppendLine("$(ideGrilla).jqGrid('editRow', rowid, { keys: true, extraparam: { __RequestVerificationToken: $('input[name^=__RequestVerificationToken]').val()} } );");

            if (navBoton.Count() > 0)
            {
                resultado.AppendLine(string.Join(" ", navBoton));
            }
            ...
            if (!esSubGrilla)
            {
                ...
                //jQuery(ideGrilla).jqGrid('filterToolbar',{defaultSearch:true,stringResult:true})
                //jQuery(ideGrilla).filterToolbar({});
                ...
                $(idePagina + ' option[value=99999999]').text('Todos');
                jQuery(ideGrilla).jqGrid('navGrid', idePagina,{ 	
                ...
                //var selr = jQuery(ideGrilla).jqGrid('getGridParam','selrow');

                $(document).one('ajaxloadstart.page', function (e) {
                    $.jgrid.gridDestroy(ideGrilla);
                    $('.ui-jqdialog').remove();
                });");
                //resultado.AppendLine(" });");
            }
        ...
        ///<summary>
        ///Determina las la Construcción de la Grilla.
        ///</summary>
        public string ToHtmlString()
        {
            return this.GeneraGrilla();
        }
    } 
}
